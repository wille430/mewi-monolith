...
const ListingPopUp = dynamic(
  () => import("@/components/ListingPopUp/ListingPopUp")
);
...
const Index = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Mewi.se - Sök efter begagnade produkter på ett enda ställe
        </title>
        <meta
          name="description"
...
Index.getLayout = (page: ReactElement) => (
  <Layout decorations={false}>{page}</Layout>
);
