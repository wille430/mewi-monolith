import { BlocketItemData, Category } from "types/types"

const CategoryService = {
    parseBlocketCategories: (categories: BlocketItemData["category"]): Category => {
        return [blocketKeyValuePair[categories[0].name], blocketKeyValuePair[categories[1].name]] || []
    },
    parseTraderaCategories: (category: string): Category => {
