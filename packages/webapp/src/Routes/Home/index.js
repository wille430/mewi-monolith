    ...
    return (
        <Layout>
            <main className="main min-w-full h-full p-0">
                <styles.Wrapper>
                    <div className="bg-blue flex flex-col items-center justify-end" style={{
                        minHeight: '45vh'
                    }}>
                        <div className="w-full flex flex-col lg:flex-row lg:items-center lg:justify-between" style={{
                            maxWidth: '1200px'
                        }}>
                            ...
                            <div className="pb-6 flex-shrink">
                                <div className="bg-transparent lg:bg-white px-6 py-12 pb-24 rounded-xl">
                                    <h1 className="text-white lg:text-black text-2xl w-full text-center inline-block pb-6">Hitta begagnade produkter på ett enda ställe</h1>
