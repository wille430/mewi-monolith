            ...
            Object.assign(
                {
                    ...
                    category: [
                        lodash_1.default.sample(Object.keys(types_1.categories)) || 'fordon',
                    ],
                    imageUrl: [faker_1.default.internet.url()],
                    isAuction: faker_1.default.datatype.boolean(),
                    redirectUrl: faker_1.default.internet.url(),
                    region: faker_1.default.address.cityName(),
                    origin: Object.values(types_1.ListingOrigins)[
                        Math.floor(Math.random() * Object.values(types_1.ListingOrigins).length)
                    ],
                    price: {
                        value: faker_1.default.datatype.number({ min: 10, max: 9999999 }),
                        currency: 'kr',
                    },
                    body: faker_1.default.lorem.paragraphs(),
                },
                data
            )
        )
