              ...
              return (
                <>
                  ...
                  <p className="px-2 text-center">
                    Vi har skickat ett mejl till {values.email}. Var vänlig följ
                    anvisningarna för att återställa lösenordet.
                  </p>
                </>
              );
              ...
              <>
                ...
                <div className="mb-8 pt-12">
                  ...
                  <h4 className="text-center text-sm font-extralight text-gray-600">
                    Har du glömt ditt lösenord? Gör en lösenordsåterställning
                    här:
                  </h4>
                </div>
